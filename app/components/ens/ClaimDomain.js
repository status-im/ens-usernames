...
const ClaimDomainAlert = ({ classes, open, handleClose }) => (
  <div>
    <Dialog
    ...
    >
      <DialogTitle id="alert-dialog-slide-title">
        {lang.t('domain.claim.alert.title')}
      </DialogTitle>
      <DialogContent>
        <DialogContentText id="alert-dialog-slide-description">
          {lang.t('domain.claim.alert.text')}
        </DialogContentText>
      </DialogContent>
...
export default withStyles(styles)(ClaimDomainAlert);
