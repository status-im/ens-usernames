...
contract ENSRegistry is ENS {
    ...
    // Permits modifications only by the owner of the specified _node.
    ...
    /**
     * @dev Transfers ownership of a _node to a new address. May only be called by the current owner of the _node.
    ...
    /**
     * @dev Transfers ownership of a subnode keccak256(_node, label) to a new address. May only be called by the owner of the parent _node.
     * @param _node The parent _node.
     * @param _label The hash of the label specifying the subnode.
     * @param _owner The address of the new owner.
     */
    ...
    /**
     * @dev Sets the resolver address for the specified _node.
     * @param _node The _node to update.
     * @param _resolver The address of the resolver.
     */
    ...
    /**
     * @dev Returns the address of the resolver for the specified _node.
     * @param _node The specified _node.
